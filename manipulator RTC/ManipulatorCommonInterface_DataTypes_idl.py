...
#
__name__ = "RTC"
_0_RTC = omniORB.openModule("RTC", r"idl\ManipulatorCommonInterface_DataTypes.idl")
_0_RTC__POA = omniORB.openModule("RTC__POA", r"idl\ManipulatorCommonInterface_DataTypes.idl")
