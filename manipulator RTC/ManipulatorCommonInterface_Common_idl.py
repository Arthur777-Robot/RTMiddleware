...
#
__name__ = "_GlobalIDL"
_0__GlobalIDL = omniORB.openModule("_GlobalIDL", r"idl\ManipulatorCommonInterface_Common.idl")
_0__GlobalIDL__POA = omniORB.openModule("_GlobalIDL__POA", r"idl\ManipulatorCommonInterface_Common.idl")
